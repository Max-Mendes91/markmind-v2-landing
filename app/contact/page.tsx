      ...
      <main className="min-h-screen bg-background overflow-x-clip">
        <div className="relative px-4 sm:px-6 md:px-8 lg:px-16 pt-28 sm:pt-32 pb-16 sm:pb-20">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            ...
            <p className="text-overlay-50 text-sm sm:text-base max-w-lg leading-relaxed mb-10 sm:mb-12">
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-overlay-40 text-xs sm:text-sm mb-0.5">Email</p>
                      <p className="text-foreground text-sm sm:text-base font-medium truncate">
                        {CONTACT_EMAIL}
                      </p>
                    </div>
                  </div>
                  <button
                    onClick={handleCopy}
                    className="shrink-0 flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg bg-overlay-5 border border-overlay-10 hover:border-overlay-20 hover:bg-overlay-8 transition-all text-xs sm:text-sm text-overlay-60 hover:text-overlay-90 cursor-pointer"
                  >
                    {copied ? (
                      <>
              ...
              <a
                ...
                className="group relative bento-card rounded-2xl p-5 sm:p-6 block hover:border-overlay-15 transition-all"
              >
                <Corners color={ORANGE} />
                <div className="flex items-center gap-3 sm:gap-4">
                  <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-overlay-5 border border-overlay-10 flex items-center justify-center">
                    <Github className="w-5 h-5 sm:w-6 sm:h-6 text-overlay-70" />
                  </div>
                  <div>
                    <p className="text-overlay-40 text-xs sm:text-sm mb-0.5">Open Source</p>
                    <p className="text-foreground text-sm sm:text-base font-medium group-hover:text-brand-orange transition-colors">
            ...
            <p className="text-overlay-30 text-xs sm:text-sm mt-8 sm:mt-10">
