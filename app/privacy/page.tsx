        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-overlay-60 text-sm sm:text-base leading-relaxed">
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-overlay-90 mt-6 mb-2">Data processed locally on your device</h3>
              <p className="mb-2">
              ...
              <h3 className="text-lg font-semibold text-overlay-90 mt-6 mb-2">Data sent to third-party AI providers</h3>
              <p className="mb-2">
              ...
              <h3 className="text-lg font-semibold text-overlay-90 mt-6 mb-2">Your API key</h3>
              <p className="mb-2">
              ...
              <h3 className="text-lg font-semibold text-overlay-90 mt-6 mb-2">Data we do NOT collect</h3>
              <p>
            ...
            <section>
              ...
              <ul className="space-y-2 ml-4">
                <li className="flex gap-2">
                  ...
                  <span><strong className="text-overlay-80">Access</strong> any personal data we hold about you (in practice, we hold none)</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-brand-orange">&#8226;</span>
                  <span><strong className="text-overlay-80">Rectification</strong> of inaccurate data</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-brand-orange">&#8226;</span>
                  <span><strong className="text-overlay-80">Erasure</strong> of your data (&quot;right to be forgotten&quot;)</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-brand-orange">&#8226;</span>
                  <span><strong className="text-overlay-80">Data portability</strong> in a machine-readable format</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-brand-orange">&#8226;</span>
                  <span><strong className="text-overlay-80">Object</strong> to processing of your data</span>
                </li>
                <li className="flex gap-2">
                  <span className="text-brand-orange">&#8226;</span>
                  <span><strong className="text-overlay-80">Lodge a complaint</strong> with your local data protection authority</span>
                </li>
              </ul>
              <p className="mt-4">
