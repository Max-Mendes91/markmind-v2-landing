...
export const BentoSection = () => (
  <section id="features" className="relative px-4 md:px-8 lg:px-16 py-28 bg-background overflow-hidden">
    ...
    <div className="relative z-10 flex flex-col items-center text-center mb-14 max-w-5xl mx-auto">
      ...
      <p className="text-overlay-50 text-lg max-w-md leading-relaxed">
    ...
    <div className="relative z-10 grid grid-cols-12 gap-4 max-w-5xl mx-auto">
      ...
      <div className="col-span-12 md:col-span-7 md:row-span-2 bento-card relative rounded-3xl p-5 flex flex-col overflow-hidden min-h-[420px] short:min-h-[320px]">
        ...
        <div>
          ...
          <p className="text-body-sm text-overlay-50 leading-relaxed">
      ...
      <div className="col-span-12 md:col-span-5 bento-card relative rounded-3xl p-5 flex flex-col overflow-hidden min-h-[200px] short:min-h-[160px]">
        ...
        <div>
          ...
          <p className="text-body-xs text-overlay-50 leading-relaxed">
