...
export const CtaSection = () => (
  <section id="get-started" className="relative px-4 md:px-8 lg:px-16 py-28 bg-background overflow-visible">
    ...
    <div className="hidden md:block absolute left-[5%] lg:left-[10%] top-0 h-full w-px pointer-events-none">
      <div className="h-full bg-linear-to-b from-overlay-6 via-overlay-4 to-transparent" />
