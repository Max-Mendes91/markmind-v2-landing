...
export const V2SignalSection = () => (
  <section id="whats-new" className="relative px-4 md:px-8 lg:px-16 py-16 md:py-20 bg-black overflow-visible">
    ...
    <div className="hidden md:block absolute left-[5%] lg:left-[10%] top-0 h-[250%] w-px pointer-events-none">
      <div className="h-full bg-linear-to-b from-transparent via-white/6 to-transparent" />
      {/* Node dot */}
    ...
    <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center text-center">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 mt-8">
        {V2_HIGHLIGHTS.map((label) => (
          <span
            key={label}
            className="px-3.5 py-1.5 rounded-full border border-white/8 bg-white/3 text-badge font-bold uppercase tracking-[0.2em] text-white/60"
          >
            {label}
          </span>
        ))}
