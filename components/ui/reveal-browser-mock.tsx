export const RevealBrowserMock = () => (
  <div className="w-[175px] glass-card rounded-2xl overflow-hidden border border-overlay-12 shadow-[0_0_60px_-10px_rgba(255,155,81,0.18)]">
    ...
    <div className="bg-overlay-4 border-b border-overlay-6 px-2.5 py-2 flex items-center gap-1.5">
      ...
      <div className="flex-1 h-1.5 rounded-full bg-overlay-8 mx-1" />
    </div>

    {/* Page content */}
    <div className="p-3 flex flex-col gap-1.5">
      <div className="w-full h-1.5 rounded-full bg-overlay-8" />
      <div className="w-5/6 h-1.5 rounded-full bg-overlay-8" />
      <div className="w-full h-1.5 rounded-full bg-overlay-6" />
      ...
      <div className="w-full h-1.5 rounded-full bg-overlay-6" />
      <div className="w-2/3 h-1.5 rounded-full bg-overlay-5" />
    </div>

    {/* MarkMind active indicator */}
    <div className="px-3 pb-3 pt-1 border-t border-overlay-5 flex items-center gap-1.5">
