      ...
      return (
        <>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-label font-black text-overlay-50 tracking-[0.2em] uppercase">You&apos;re reading</span>
          </div>
      ...
      return (
        <>
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-label font-black text-overlay-50 tracking-[0.2em] uppercase">AI reads the page</span>
          </div>
          ...
          <div className="mt-2.5 flex items-center gap-1.5">
            ...
            <span className="text-label text-overlay-55 font-bold uppercase tracking-wider">Extracting page context</span>
          </div>
        </>
      )
      ...
      return (
        <>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-label font-black text-overlay-50 tracking-[0.2em] uppercase">Your folders are mapped</span>
          </div>
          <div className="rounded-xl bg-overlay-3 border border-overlay-6 p-3 mb-3">
            <p className="text-caption text-overlay-55 leading-relaxed">
        ...
        <>
          <div className="flex items-start justify-between gap-4 mb-4">
            <div>
              ...
              <p className="text-caption text-overlay-50">
      ...
      return (
        <>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-label font-black text-overlay-50 tracking-[0.2em] uppercase">You approve</span>
          </div>
          <div className="rounded-xl bg-overlay-3 border border-overlay-6 p-3 mb-3">
            <p className="text-caption text-overlay-55 leading-relaxed">
